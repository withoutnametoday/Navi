 ...
 * @author HP
 */
public class Jtareas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField6.setText("FechaPrueba_lejana");
        jTextField6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField6ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, -1, 30));

        jTextField7.setText("FechaPrueba_cercana");
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, -1, -1));

        jTextField8.setText("FechaPrueba_medio");
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jtareas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
